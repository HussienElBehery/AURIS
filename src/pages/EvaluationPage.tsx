...
import { Brain, MessageSquare, Heart, CheckCircle, Filter, TrendingUp, Database } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Evaluation Data Available</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Evaluation results will appear here once you start using the system and upload chat logs
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Charts will appear here once evaluation data is available
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              AI reasoning and analysis will appear here once evaluations are performed
            </p>
          </div>
        </div>
      </div>
