...
import { Download, Filter, BarChart3, TrendingUp, Users, Calendar, Database } from 'lucide-react';
...
const ReportPage: React.FC = () => {
  ...
  const filteredChats = isDemoUser 
    ? MOCK_CHATLOGS.filter(chat => {
  ...
  const filteredEvaluations = isDemoUser 
  ...
  const agentPerformance = isDemoUser 
  ...
  const guidelineCompliance = isDemoUser 
    ...
    : {}; // Empty object for official users
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Team reports will appear here once you start using the system and have team activity
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Team Metrics</h3>
            <p className="text-gray-600 dark:text-gray-400">
              Team performance charts will appear here once data is available
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Agent Performance</h3>
            <p className="text-gray-600 dark:text-gray-400">
              Agent comparison charts will appear here once data is available
            </p>
          </div>
        </div>
      </div>
